...
import {data,product,cart,payment,total,uplPhoto,logIn,count,chngProfile,user,chngPass,token,profile,status,address,change} from "./reducer";
const reducers = combineReducers({data,product,uplPhoto,logIn,chngProfile,cart,chngPass,profile,payment,total,count,user,token,status,address,change});
